...
namespace TussentijdsProjectYannick
{
    ...
    public partial class Projectweek_YannickEntities : DbContext
    {
        public Projectweek_YannickEntities()
            : base("name=Projectweek_YannickEntities")
        {
        }
        ...
        public virtual DbSet<AdminRechten> AdminRechtens { get; set; }
